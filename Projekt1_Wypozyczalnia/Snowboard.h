...
class Snowboard : public wxDialog
{
public:
	Snowboard(wxWindow* parent, int ID);
...
private:
	...
	wxStaticText* text_model_snowboard;
	...
	wxChoice* choice_model_snowboard;
