...
Rejestracja::Rejestracja(wxWindow* parent) : wxDialog(parent, wxID_ANY, "Narty", wxDefaultPosition, wxSize(1000, 740))
{
	...
	//mid-------------------------------------------------------------------------------------
	text_nazwa = new wxStaticText(panel_mid, wxID_ANY, "Rejestracja", wxPoint(20, 24));
	...
	text_static_potwierdz_haslo = new wxStaticText(panel_main2, wxID_ANY, "Potwierdz haslo:", wxPoint(390, 200));
	text_ctrl_potwierdz_haslo = new wxTextCtrl(panel_main2, wxID_ANY, "Haslo", wxPoint(330, 230), wxSize(200, -1), wxTE_PASSWORD);

	button_zarejestruj = new wxButton(panel_main2, wxID_ANY, "Zarejestruj", wxPoint(390, 280), wxSize(90, 35));
